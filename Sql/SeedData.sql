...
('S005', N'Ministop quan 1', N'23 Lê Lợi, Quận 1, TP.HCM', '090933341', 0, N'System', GETDATE()),
...
VALUES
-- ADMIN (Fulltime)
('E001', Null, N'Nguyễn Văn Minh', 1, '1990-03-12', '0905123456', N'Admin', N'Fulltime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL),
...
('E006', 'S002', N'Đỗ Thành Nam', 1, '2000-04-22', '0913344556', N'Nhân viên', N'Parttime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL),
('E007', 'S002', N'Võ Thị Mai', 0, '1997-07-09', '0932223344', N'Nhân viên', N'Fulltime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL),
('E008', 'S003', N'Bùi Thị Ngọc', 0, '2001-09-03', '0978899001', N'Nhân viên', N'Parttime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL),
('E009', 'S003', N'Trịnh Văn Hải', 1, '1999-12-28', '0932233445', N'Nhân viên', N'Fulltime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL),
('E010', 'S001', N'Phan Thị Yến', 0, '1996-08-05', '0909777666', N'Nhân viên', N'Parttime', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', 0, N'System', GETDATE(), NULL, NULL);
GO
...
VALUES
-- Tháng 09/2025
('EXP001', 'S001', '2025-09', 35000000, 4200000, 850000, N'Chi phí tháng 9', 0, N'E002', GETDATE(), NULL, NULL),
('EXP002', 'S002', '2025-09', 30000000, 3800000, 700000, N'Chi phí tháng 9', 0, N'E003', GETDATE(), NULL, NULL),
('EXP003', 'S003', '2025-09', 27000000, 3100000, 650000, N'Chi phí tháng 9', 0, N'E004', GETDATE(), NULL, NULL);
GO
