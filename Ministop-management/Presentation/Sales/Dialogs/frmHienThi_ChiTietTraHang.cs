...
{
    public partial class frmHienThi_ChiTietTraHang : Form
    {
        ...
        public frmHienThi_ChiTietTraHang(IStockImportDetailSerivce stockImportDetailSerivce, IUserSession userSession, IUnityContainer container, string ImportID = null, string Status = null, string supplierID = null)
        {
            InitializeComponent();
